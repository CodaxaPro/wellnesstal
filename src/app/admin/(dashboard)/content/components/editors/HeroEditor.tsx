...
handleHeroImageUpload(file)
      ...
      <div className="p-4 bg-white rounded-xl border border-gray-200 space-y-6">
        <h3 className="text-lg font-semibold text-charcoal mb-4">Görsel Üzerindeki Floating Elementler</h3>

        {/* Status Badge */}
        <div className="space-y-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <label className="block text-sm font-semibold text-charcoal mb-1">Durum Rozeti (Jetzt geöffnet)</label>
              <p className="text-xs text-gray-500">Görsel üzerinde gösterilecek durum rozeti</p>
            </div>
              ...
              <input
                ...
                onChange={(e) => setEditingContent((prev: any) => ({
                  ...
                  imageFloatingElements: {
                    ...prev.imageFloatingElements,
                    statusBadge: {
                      ...prev.imageFloatingElements?.statusBadge,
                      enabled: e.target.checked,
                      text: prev.imageFloatingElements?.statusBadge?.text || 'Jetzt geöffnet',
                      position: prev.imageFloatingElements?.statusBadge?.position || { vertical: 'top', horizontal: 'left' }
                    }
                  }
                }))}
                disabled={!isEditing}
          ...
          {content.imageFloatingElements?.statusBadge?.enabled !== false && (
            <div className="space-y-3 mt-4">
              <div>
                ...
                <input
                  type="text"
                  value={content.imageFloatingElements?.statusBadge?.text || 'Jetzt geöffnet'}
                  onChange={(e) => setEditingContent((prev: any) => ({
                    ...prev,
                    imageFloatingElements: {
                      ...prev.imageFloatingElements,
        ...
        <div className="space-y-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">Görsel üzerinde gösterilecek premium hizmet kartı</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
                ...
                onChange={(e) => setEditingContent((prev: any) => ({
                  ...
                  imageFloatingElements: {
                    ...prev.imageFloatingElements,
                    premiumCard: {
                      ...prev.imageFloatingElements?.premiumCard,
                      enabled: e.target.checked,
                      emoji: prev.imageFloatingElements?.premiumCard?.emoji || '🧘🏻‍♀️',
                      title: prev.imageFloatingElements?.premiumCard?.title || 'Premium Headspa',
                      subtitle: prev.imageFloatingElements?.premiumCard?.subtitle || '90 Min • ab 85€',
                      position: prev.imageFloatingElements?.premiumCard?.position || { vertical: 'bottom', horizontal: 'left' }
                    }
                  }
                }))}
                disabled={!isEditing}
          ...
          {content.imageFloatingElements?.premiumCard?.enabled !== false && (
            <div className="space-y-3 mt-4">
              <div>
                ...
                <input
                  type="text"
                  value={content.imageFloatingElements?.premiumCard?.emoji || '🧘🏻‍♀️'}
                  onChange={(e) => setEditingContent((prev: any) => ({
                    ...prev,
                    imageFloatingElements: {
                      ...prev.imageFloatingElements,
              ...
              <div>
                ...
                <input
                  type="text"
                  value={content.imageFloatingElements?.premiumCard?.title || 'Premium Headspa'}
                  onChange={(e) => setEditingContent((prev: any) => ({
                    ...prev,
                    imageFloatingElements: {
                      ...prev.imageFloatingElements,
              ...
              <div>
                ...
                <input
                  type="text"
                  value={content.imageFloatingElements?.premiumCard?.subtitle || '90 Min • ab 85€'}
                  onChange={(e) => setEditingContent((prev: any) => ({
                    ...prev,
                    imageFloatingElements: {
                      ...prev.imageFloatingElements,
              ...
              <input
                ...
                onChange={(e) => setEditingContent((prev: any) => ({
                  ...
                  imageFloatingElements: {
                    ...prev.imageFloatingElements,
                    reviewsBadge: {
                      ...prev.imageFloatingElements?.reviewsBadge,
                      enabled: e.target.checked,
                      rating: prev.imageFloatingElements?.reviewsBadge?.rating || '4.9',
                      text: prev.imageFloatingElements?.reviewsBadge?.text || 'Google Reviews',
                      position: prev.imageFloatingElements?.reviewsBadge?.position || { vertical: 'top', horizontal: 'right' }
                    }
                  }
                }))}
                disabled={!isEditing}
          ...
          {content.imageFloatingElements?.reviewsBadge?.enabled !== false && (
            <div className="space-y-3 mt-4">
              <div>
                ...
                <input
                  type="text"
                  value={content.imageFloatingElements?.reviewsBadge?.rating || '4.9'}
                  onChange={(e) => setEditingContent((prev: any) => ({
                    ...prev,
                    imageFloatingElements: {
                      ...prev.imageFloatingElements,
              ...
              <div>
                ...
                <input
                  type="text"
                  value={content.imageFloatingElements?.reviewsBadge?.text || 'Google Reviews'}
                  onChange={(e) => setEditingContent((prev: any) => ({
                    ...prev,
                    imageFloatingElements: {
                      ...prev.imageFloatingElements,
